        ...
        {roomMessages.map((msg) => {
          ...
          return (
            <div
              ...
              className={clsx('relative', contextSelectionMode && 'cursor-pointer', isCtxSelected && 'bg-primary-500/20 ring-1 ring-primary-500/30 rounded-lg')}
            ...
            >
              {contextSelectionMode && (
                <div className="absolute left-1 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-5 h-5">
                  <div className={clsx(
                    'w-4 h-4 rounded border-2 flex items-center justify-center transition-colors',
                    isCtxSelected
                      ? 'bg-primary-500 border-primary-500'
                      : 'border-dark-muted bg-dark-surface'
                  )}>
                    {isCtxSelected && (
